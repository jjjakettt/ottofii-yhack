...
Before writing any code or reviewing any plan, read the following docs in order:

1. **[docs/TEAM.md](docs/TEAM.md)** — ownership map, API contracts, shared Pydantic types, and stubs. This is the source of truth for how the four work streams connect. Do not write code that crosses a boundary without consulting it.
2. **[docs/ARCHITECTURE.md](docs/ARCHITECTURE.md)** — system design, layer responsibilities, and which person owns what.
3. **[docs/HACKATHON_PLAN.md](docs/HACKATHON_PLAN.md)** — task breakdown by person and priority stack.

If an interface you need isn't ready yet, use the stub defined in TEAM.md — do not invent your own shape.
If you need to change a shared interface, flag it explicitly and update TEAM.md before writing code.
